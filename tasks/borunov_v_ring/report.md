...
Тесты производительности неприменимы к данной задаче, так как используются задержки для иметации работы на каждом процессе и по сравнению с ними время выполнения передачи данный несоизмеримо.
Дажк при запуске на 100 процессах время выполнения составляет 20.0381 при учете задержки 200ms на процесс время выполнения передачи составляет 0.0381.
